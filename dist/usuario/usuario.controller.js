...
let UsuarioController = exports.UsuarioController = class UsuarioController {
    ...
    async RetornoUsuarios() {
        ...
        const listaRetorno = usuariosListados.map(usuario => new listaUsuario_dto_1.ListaUsuarioDTO(usuario.id, usuario.nome, usuario.sobrenome, usuario.email, usuario.confirmaemail, usuario.telefoneum, usuario.telefonedois, usuario.login, usuario.senha));
        return listaRetorno;
    }
    async retornoUsuarioId(id) {
    ...
    async criaUsuario(dadosUsuario) {
        var usuario = new usuario_entity_1.UsuarioEntity((0, uuid_1.v4)(), dadosUsuario.nome, dadosUsuario.sobrenome, dadosUsuario.email, dadosUsuario.confirmaemail, dadosUsuario.telefoneum, dadosUsuario.telefonedois, dadosUsuario.login, dadosUsuario.senha);
        var retornoUsuario;
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UsuarioController.prototype, "retornoUsuarioId", null);
__decorate([
    (0, common_1.Post)(),
